...
public class MetadataJSON1036Test512A3Local3GHI2 {
   ...
   public static void generateGraph()
   {
    ...
    public static void main(String[] arg) throws IOException, CloneNotSupportedException {
      //  System.out.println("Hello");
        ...
        /*********/
      MetadataService.initCardinalityMap();
      MetadataService.hardCodeBusinessKeys();
        ...
        BufferedReader br = new BufferedReader(new FileReader("C:\\githubrepos\\Nereus\\files\\GHI_CUSTOMER3Formatted.txt"));
        ...
        for (String line; (line=br.readLine()) !=null;)
        {
         ...
         //   cust.POLICY=objCus.getInt("POLICY");
            //cust.CUSTOMERTIME= UUID.randomUUID().toString();
            cust.CUSTOMERTIME= objCus.getString("customertime");
      ...
      // System.out.println("Number of customer lines "+i);
        ...
        br = new BufferedReader(new FileReader("C:\\githubrepos\\Nereus\\files\\GHI_POLICY3Formatted.txt"));
      ...
      // br = new BufferedReader(new FileReader("/home/statarm/playground/Code/tomekl007-packt_algo-44b37f423231/policyTest2.txt"));
        ...
        for(String line; (line=br.readLine()) !=null;)
        {
            ...
            policy.POLICYSTARTTIME = objPol.getString("policystarttime");
            policy.CUSTOMER = objPol.getString("customer");
            policy.POLICYENDTIME  = objPol.getString("policyendtime");
        ...
        br = new BufferedReader(new FileReader("C:\\githubrepos\\Nereus\\files\\GHI_CLAIM3Formatted.txt"));
       ...
       // br = new BufferedReader(new FileReader("/home/statarm/playground/Code/tomekl007-packt_algo-44b37f423231/claim1.txt"));
        ...
        for(String line; (line=br.readLine()) !=null;)
        {
            ...
            claim.CLAIMTIME = objClaim.getString("claimtime");
            claim.CLAIMREPORTTIME = objClaim.getString("claimreporttime");
        ...
        br = new BufferedReader(new FileReader("C:\\githubrepos\\Nereus\\files\\GHI_CLAIMPAYMENT3Formatted.txt"));
      ...
      // br = new BufferedReader(new FileReader("/home/statarm/playground/Code/tomekl007-packt_algo-44b37f423231/paymentTest1.txt"));
        ...
        for(String line; (line=br.readLine()) !=null;)
        {
            ...
            //payment.PAYTIME = UUID.randomUUID().toString();
            payment.PAYTIME = objPayment.getString("paytime");
            payment.PAYMENT = objPayment.getString("payment");
        ...
        br = new BufferedReader(new FileReader("C:\\githubrepos\\Nereus\\files\\GHI_ADDRESS3Formatted.txt"));
       ...
       for(String line; (line=br.readLine()) !=null;)
       {
           ...
           address.ADDRESSTIME = objAddress.getString("addresstime");
 ...
 /********************************************************/
    ...
    /***TESTING BUSINESS KEYS**/
       SOURCE_NODES.forEach((nodeName)->{
           System.out.println(nodeName);
           Collection<Sextet<String,Set<String>,Long,String,Set<String>,Long>> properSub= (Collection) PROPERSUBSET.get(nodeName);
         if(properSub!=null) {
             properSub.forEach((e) -> {


               //  MetadataService.isBusinessKey(e.getValue0(), e.getValue1());
              //  MetadataService.isBusinessKey(e.getValue3(), e.getValue4());
                 //System.out.println(e.getValue0()+" "+e.getValue1()+" "+MetadataService.isBusinessKey(e.getValue0(), e.getValue1()));
                // System.out.println(e.getValue3()+" "+e.getValue4()+MetadataService.isBusinessKey(e.getValue3(), e.getValue4()));
             });
         }
       });
     /**  System.out.println("SetCardinality");
      ...
      System.out.println("Printing join tuples ");
      TMPJOINTUPLES.forEach((k,v)->{
          System.out.println("Key "+k);
          System.out.println("Value "+v);
     ...
     /** System.out.println("######################");
      NODES.forEach((e)->{
          ...
          NODES.forEach(e1->{
             ...
             System.out.println( MetadataService.checkMatchProperSubset(lname,rname));
             System.out.println(MetadataService.checkMatchProperSubsetWithDictionary(lname,rname));
          });
      });**/
    }//main
}//class